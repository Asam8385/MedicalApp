...
router.get('/doctor/invoices', (0, auth_1.auth)(enums_1.AuthUser.DOCTOR, enums_1.AuthUser.ADMIN), appointment_controller_1.AppointmentController.getDoctorInvoices);
router.get('/doctor/appointments', (0, auth_1.auth)(enums_1.AuthUser.DOCTOR, enums_1.AuthUser.ADMIN), appointment_controller_1.AppointmentController.getDoctorAppointmentsById);
router.get('/doctor/patients', (0, auth_1.auth)(enums_1.AuthUser.DOCTOR, enums_1.AuthUser.ADMIN), appointment_controller_1.AppointmentController.getDoctorPatients);
...
//doctor side
router.patch('/doctor/update-appointment', (0, auth_1.auth)(enums_1.AuthUser.DOCTOR, enums_1.AuthUser.ADMIN), appointment_controller_1.AppointmentController.updateAppointmentByDoctor);
