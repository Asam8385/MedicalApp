...
const getAllunverifiedDoctors = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = (0, pick_1.default)(req.query, doctor_interface_1.IDoctorFiltersData);
    const options = (0, pick_1.default)(req.query, doctor_interface_1.IDoctorOptions);
    const result = yield doctor_service_1.DoctorService.getAllunverifiedDoctors(filter, options);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        message: 'Successfully Retrieve doctors !!',
        success: true,
